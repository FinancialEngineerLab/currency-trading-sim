...
void MerkelMain::printMarketStats() {
    ...
    for (std::string const& p : orderBook.getKnownProduct()) {
        ...
        double askMean = OrderBook::getMeanValue(entries);
        std::cout << "Mean asks: " << askMean << std::endl;

        std::cout << "Bids seen: " << bid_entries.size() << std::endl;
        std::cout << "Max bids: " << OrderBook::getHighPrice(bid_entries) << std::endl;
        std::cout << "Min bids: " << OrderBook::getLowPrice(bid_entries) << std::endl;
        double bidMean = OrderBook::getMeanValue(bid_entries);
        std::cout << "Mean bid: " << bidMean << std::endl;

        std::cout << "Difference between ask mean and bid mean: " << OrderBook::diffBidAsk(askMean, bidMean) << "%" << std::endl;
